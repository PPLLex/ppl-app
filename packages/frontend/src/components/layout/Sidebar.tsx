...
const adminNav: NavItem[] = [
  ...
  { label: 'CRM / Leads', href: '/admin/crm', icon: <Icons.Target /> },
  ...
  { label: 'Invite Staff', href: '/admin/invite', icon: <Icons.UserGroup /> },
  { label: 'Partner Schools', href: '/admin/schools', icon: <Icons.Location /> },
  { label: 'Finance', href: '/admin/finance', icon: <Icons.Chart /> },
  ...
  { label: 'Campaigns', href: '/admin/campaigns', icon: <Icons.Chat /> },
...
export default function Sidebar({ isOpen, onClose }: { isOpen?: boolean; onClose?: () => void }) {
  ...
  const navItems =
    user.role === 'ADMIN' ? adminNav : user.role === 'STAFF' ? staffNav : clientNav;
