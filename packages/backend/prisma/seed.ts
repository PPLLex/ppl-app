...
async function main() {
  ...
  // DESCRIPTIONS: kept in sync with src/bootstrapMembershipPlans.ts (which is
  // the production source of truth). If you edit copy here, edit it there too.
  const planDefs: PlanSeed[] = [
    ...
    { id: 'plan-unlimited-pitching', name: 'Unlimited Pitching',         slug: 'unlimited-pitching',         ageGroup: 'ms_hs',   sessionsPerWeek: null, priceCents: 8500,  billingCycle: 'weekly',  description: 'Train in-house up to 6 days per week.',                       includesHitting: false, pairedWithPlanId: 'plan-unlimited-pitching-hitting', revenueSplits: { ppl: 8500 } },
    { id: 'plan-unlimited-college',  name: 'Unlimited College Pitching', slug: 'unlimited-college-pitching', ageGroup: 'college', sessionsPerWeek: null, priceCents: 8500,  billingCycle: 'weekly',  description: 'Train in-house up to 6 days per week.',                       includesHitting: false, pairedWithPlanId: 'plan-unlimited-college-hitting',  revenueSplits: { ppl: 8500 } },
    ...
    { id: 'plan-unlimited-pitching-hitting', name: 'Unlimited Pitching + Hitting',         slug: 'unlimited-pitching-hitting',     ageGroup: 'ms_hs',   sessionsPerWeek: null, priceCents: 12500, billingCycle: 'weekly', description: 'Train your pitching & hitting in-house up to 6 days per week.',         includesHitting: true, pairedWithPlanId: 'plan-unlimited-pitching', revenueSplits: { ppl: 6750, hpl: 5750 } },
    { id: 'plan-unlimited-college-hitting',  name: 'Unlimited College Pitching + Hitting', slug: 'unlimited-college-hitting',      ageGroup: 'college', sessionsPerWeek: null, priceCents: 12500, billingCycle: 'weekly', description: 'Train your pitching & hitting in-house up to 6 days per week.',         includesHitting: true, pairedWithPlanId: 'plan-unlimited-college',  revenueSplits: { ppl: 6750, hpl: 5750 } },
