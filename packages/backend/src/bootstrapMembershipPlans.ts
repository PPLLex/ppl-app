...
const PLANS: PlanSeed[] = [
  ...
  { id: 'plan-youth-1x',           name: 'Youth 1x/Week',              slug: 'youth-1x-week',              ageGroup: 'youth',   sessionsPerWeek: 1,    priceCents: 5500,  billingCycle: 'weekly',  description: 'One pitching session a week. Ages 12 and under.',               includesHitting: false, pairedWithPlanId: 'plan-youth-1x-hitting',           revenueSplits: { ppl: 5500 } },
  { id: 'plan-1x-pitching',        name: '1x/Week Pitching',           slug: '1x-week-pitching',           ageGroup: 'ms_hs',   sessionsPerWeek: 1,    priceCents: 7000,  billingCycle: 'weekly',  description: 'One pitching session a week.',                                  includesHitting: false, pairedWithPlanId: 'plan-1x-pitching-hitting',        revenueSplits: { ppl: 7000 } },
  { id: 'plan-unlimited-pitching', name: 'Unlimited Pitching',         slug: 'unlimited-pitching',         ageGroup: 'ms_hs',   sessionsPerWeek: null, priceCents: 8500,  billingCycle: 'weekly',  description: 'Train as often as you want.',                                   includesHitting: false, pairedWithPlanId: 'plan-unlimited-pitching-hitting', revenueSplits: { ppl: 8500 } },
  { id: 'plan-unlimited-college',  name: 'Unlimited College Pitching', slug: 'unlimited-college-pitching', ageGroup: 'college', sessionsPerWeek: null, priceCents: 8500,  billingCycle: 'weekly',  description: 'Unlimited pitching for college arms.',                          includesHitting: false, pairedWithPlanId: 'plan-unlimited-college-hitting',  revenueSplits: { ppl: 8500 } },

  // ── PITCHING + HITTING COMBOS — PPL + HPL split ─────────────────────────
  { id: 'plan-youth-1x-hitting',           name: 'Youth 1x/Week + Hitting',      slug: 'youth-1x-week-hitting',          ageGroup: 'youth',   sessionsPerWeek: 1,    priceCents: 9000,  billingCycle: 'weekly', description: 'One pitching and one hitting session a week. Ages 12 and under.', includesHitting: true,  pairedWithPlanId: 'plan-youth-1x',           revenueSplits: { ppl: 5000, hpl: 4000 } },
  { id: 'plan-1x-pitching-hitting',        name: '1x/Week Pitching + Hitting',   slug: '1x-week-pitching-hitting',       ageGroup: 'ms_hs',   sessionsPerWeek: 1,    priceCents: 10500, billingCycle: 'weekly', description: 'One pitching and one hitting session a week.',                    includesHitting: true,  pairedWithPlanId: 'plan-1x-pitching',        revenueSplits: { ppl: 5750, hpl: 4750 } },
  { id: 'plan-unlimited-pitching-hitting', name: 'Unlimited Pitching + Hitting', slug: 'unlimited-pitching-hitting',     ageGroup: 'ms_hs',   sessionsPerWeek: null, priceCents: 12500, billingCycle: 'weekly', description: 'Unlimited pitching and hitting.',                                 includesHitting: true,  pairedWithPlanId: 'plan-unlimited-pitching', revenueSplits: { ppl: 6750, hpl: 5750 } },
  { id: 'plan-unlimited-college-hitting',  name: 'Unlimited College + Hitting',  slug: 'unlimited-college-hitting',      ageGroup: 'college', sessionsPerWeek: null, priceCents: 12500, billingCycle: 'weekly', description: 'Unlimited pitching and hitting for college athletes.',            includesHitting: true,  pairedWithPlanId: 'plan-unlimited-college',  revenueSplits: { ppl: 6750, hpl: 5750 } },

  // ── PRO (MONTHLY billing, no hitting) — 100% PPL ────────────────────────
  { id: 'plan-pro-facility-access',      name: 'Pro — Facility Access',       slug: 'pro-facility-access',       ageGroup: 'pro', sessionsPerWeek: null, priceCents: 10000, billingCycle: 'monthly', description: 'Unlimited facility access.',                              includesHitting: false, pairedWithPlanId: null, revenueSplits: { ppl: 10000 } },
  { id: 'plan-pro-programming',          name: 'Pro — Programming',           slug: 'pro-programming',           ageGroup: 'pro', sessionsPerWeek: 0,    priceCents: 10000, billingCycle: 'monthly', description: 'Custom monthly programming built for your arm.',          includesHitting: false, pairedWithPlanId: null, revenueSplits: { ppl: 10000 } },
  { id: 'plan-pro-programming-access',   name: 'Pro — Programming + Access',  slug: 'pro-programming-access',    ageGroup: 'pro', sessionsPerWeek: null, priceCents: 17500, billingCycle: 'monthly', description: 'Custom programming plus unlimited facility access.',      includesHitting: false, pairedWithPlanId: null, revenueSplits: { ppl: 17500 } },
  { id: 'plan-pro-programming-training', name: 'Pro — Programming + Training', slug: 'pro-programming-training', ageGroup: 'pro', sessionsPerWeek: null, priceCents: 8500,  billingCycle: 'weekly',  description: 'Custom programming plus hands-on weekly coaching.',       includesHitting: false, pairedWithPlanId: null, revenueSplits: { ppl: 8500 } },
];
