          ...
          {coaches.map(coach => (
            <div key={coach.id} className="ppl-card flex items-center justify-between">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-full bg-ppl-dark-green/10 flex items-center justify-center shrink-0">
              ...
              <div className="flex items-center gap-3">
                {coach.acceptedAt ? (
                  <span className="text-xs bg-ppl-dark-green/10 text-ppl-light-green px-2 py-1 rounded">Connected</span>
                ) : (
...
function AddCoachForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="ppl-card border-2 border-ppl-dark-green/20">
